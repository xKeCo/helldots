...
minute — the renderer's own 30 second deadline, paid twice because it drops
the failed URL from its request cache — and the capture still succeeds with
that asset replaced by a placeholder. The wait is bounded rather than
multiplied: one dead asset and ten cost the same.
