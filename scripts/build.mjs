...
// html2canvas is left external so it doesn't blow the size budget — apps
// importing this bundle resolve it from their own node_modules/bundler.
await build({
...
// bundler available. html2canvas IS bundled here so the file is fully
